    ...
    describe('project operations', () => {
      ...
      describe('add project', () => {
        ...
        it('add project', () => {
          ...
          cy.get('.cdk-overlay-pane').within(() => {
            cy.contains("Apartments").click({ force: true, multiple: true })
          })
      ...
      describe('edit project', () => {
        ...
        it('edit with new values', () => {
          ...
          cy.get('input[name="arName"]').type('تست')
          cy.get('.cdk-overlay-pane').within(() => {
            cy.contains("Apartments").dblclick({ force: true, multiple: true })
          })
          cy.get('input[value="1"]').check({ force: true })
        ...
        it('Edit to already Existing project', () => {
          ...
          cy.get('.btn-info').click()
          cy.get('input[name="enName"]').clear()
          cy.get('input[name="enName"]').type('CypressProject')
          cy.get('input[name="arName"]').clear()
          cy.get('input[name="arName"]').type('CypressProject')
          cy.get('.cdk-overlay-pane').within(() => {
            cy.contains("Apartments").dblclick({ force: true, multiple: true })
          })
          cy.get('input[value="1"]').check({ force: true })
